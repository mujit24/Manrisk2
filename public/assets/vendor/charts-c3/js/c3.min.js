!(function (t, e) {
    ...
    ((a = t.prototype).axisX = function (t, e, i) {
        ...
        (a.generateTicks = function (t) {
            ...
            return (
                a.length > 0 && a[0] > 0 && a.unshift(a[0] - (a[1] - a[0])), a
            );
        }),
    ...
    return (
        ...
        (C.transformMain = function (t, e) {
            ...
            e && e.axisX
                ? (i = e.axisX)
                : ((i = o.main.select("." + r.axisX)),
                  t && (i = i.transition())),
                e && e.axisY
                    ? (n = e.axisY)
                    : ((n = o.main.select("." + r.axisY)),
                      t && (n = n.transition())),
                e && e.axisY2
                    ? (a = e.axisY2)
                    : ((a = o.main.select("." + r.axisY2)),
                      t && (a = a.transition())),
        ...
        (P.focus = function (t) {
            ...
            (t = i.mapToTargetIds(t)),
                (e = i.svg.selectAll(
                    i.selectorTargets(t.filter(i.isTargetToShow, i))
                )),
                this.revert(),
                this.defocus(),
            ...
            t.mouse && (i = t.mouse),
                t.data
                    ? n.isMultipleX()
                        ? ((i = [
                              n.x(t.data.x),
                              n.getYScale(t.data.id)(t.data.value),
                          ]),
                          (e = null))
                        : (e = l(t.data.index)
                              ? t.data.index
                              : n.getIndexByX(t.data.x))
                    : void 0 !== t.x
                    ? (e = n.getIndexByX(t.x))
        ...
        (C.getArcRatio = function (t) {
            var e = this,
                ...
                n =
                    Math.PI *
                    (e.hasType("gauge") && !i.gauge_fullCircle ? 1 : 2);
            ...
            i.transiting
                ? (e = window.setInterval(function () {
                      i.transiting ||
                          ...
                          i.legend.selectAll(".c3-legend-item-focused").size() >
                              0 && i.expandArc(t));
                  }, 10))
                : ((t = i.mapToTargetIds(t)),
                  i.svg
        ...
        (C.meetsArcLabelThreshold = function (t) {
            ...
            return (
                t >=
                (e.hasType("donut")
                    ? i.donut_label_threshold
                    : i.pie_label_threshold)
            );
        }),
            ...
            (n = c
                        ...
                        s.interaction_enabled
                            ? function (t) {
                                  var e,
                                      i = a.updateAngle(t);
                                  i &&
                                      ((e = [a.convertToArcData(i)]),
                                      a.showTooltip(e, this));
                              }
                            : null
                    )
                    .on(
                ...
                c
                    ...
                    .style("opacity", function (t) {
                        return a.isTargetToShow(t.data.id) &&
                            a.isArcType(t.data)
                            ? 1
                            : 0;
                    }),
                c
                    ...
                    .style(
                        "opacity",
                        a.hasType("donut") || a.hasType("gauge") ? 1 : 0
                    ),
                a.hasType("gauge") &&
                    (a.arcs
                        .select("." + r.chartArcsBackground)
                        .attr("d", function () {
                            var t = {
                    ...
                    a.arcs
                        ...
                        .text(
                            s.gauge_label_show
                                ? a.textForGaugeMinMax(s.gauge_min, !1)
                                : ""
                        ),
                    a.arcs
                        ...
                        .text(
                            s.gauge_label_show
                                ? a.textForGaugeMinMax(s.gauge_max, !0)
                                : ""
                        ));
        }),
        ...
        (C.classArc = function (t) {
            return (
                this.classShape(t.data) + this.generateClass(r.arc, t.data.id)
            );
        }),
        (C.classArcs = function (t) {
            return (
                this.classShapes(t.data) + this.generateClass(r.arcs, t.data.id)
            );
        }),
        ...
        (C.classFocused = function (t) {
            return (
                " " +
                (this.focusedTargetIds.indexOf(t.id) >= 0 ? r.focused : "")
            );
        }),
        ...
        (C.getYAxisClipX = function () {
            var t = this;
            return t.config.axis_y_inner
                ? -1
                : t.getAxisClipX(t.config.axis_rotated);
        }),
                ...
                r.forEach(function (i) {
                    ...
                    n.isCustomX() || n.isTimeSeries()
                        ? o.indexOf(r) >= 0
                            ...
                            : S(a.data_xs) &&
                              (n.data.xs[i] = n.getXValuesOfXKey(
                                  r,
                                  n.data.targets
                              ))
            ...
            return (
                ...
                0 === x.length
                    ...
                    : (isNaN(v) && (v = 0),
                      ...
                      (r = o = 0.1 * a),
                      void 0 !== T &&
                          ((b = T + (s = Math.max(Math.abs(v), Math.abs(b)))),
                          (v = T - s)),
                      C
        ...
        (C.getXDomainPadding = function (t) {
            ...
            return (
                ...
                "object" === o(s.axis_x_padding) && S(s.axis_x_padding)
                    ? ((n = l(s.axis_x_padding.left)
                          ? s.axis_x_padding.left
                          : i),
                      (a = l(s.axis_x_padding.right)
                          ? s.axis_x_padding.right
                          : i))
                    : (n = a =
                          "number" == typeof s.axis_x_padding
                              ? s.axis_x_padding
                              : i),
                { left: n, right: a }
            );
                ...
                (u.data_selection_enabled &&
                    ((u.zoom_enabled && !l.zoom.altDomain) ||
                        (u.data_selection_multiple &&
                            ...
                            (o = Math.min(e, n)),
                            (s = Math.max(e, n)),
                            (c = u.data_selection_grouped
                                ? l.margin.top
                                : Math.min(i, a)),
                            (d = u.data_selection_grouped
                                ? l.height
                                : Math.max(i, a)),
                            h
                                .select("." + r.dragarea)
                ...
                .on("mousemove", function (t) {
                    ...
                    e.dragging ||
                        ...
                        (e.isStepType(t) &&
                            ...
                            (o -= 1),
                        (a = e
                            .filterTargetsToShow(e.data.targets)
                            .map(function (t) {
                                return e.addName(
                                    e.getValueOnIndex(t.values, o)
                                );
                            })),
                        n.tooltip_grouped &&
                            (e.showTooltip(a, this), e.showXGridFocus(a)),
                        (!n.tooltip_grouped ||
                    ...
                    !e.hasArcType() &&
                        ...
                        (e.cancelClick
                            ...
                            : (e.isStepType(t) &&
                                  ...
                                  i.mouse(this)[0] <
                                      e.x(e.getXValue(t.id, a)) &&
                                  (a -= 1),
                              e.main
                                  .selectAll("." + r.shape + "-" + a)
                                  .each(function (t) {
                                      (n.data_selection_grouped ||
                                          e.isWithinShape(this, t)) &&
                    ...
                    i.dragging ||
                        ...
                        o
                            ? ((s = (
                              ...
                              i.showXGridFocus(s),
                              (i.isBarType(o.id) ||
                                  i.dist(o, t) < a.point_sensitivity) &&
                                  (i.svg
                                      .select("." + r.eventRect)
                                      .style("cursor", "pointer"),
                                  i.mouseover ||
                                      (a.data_onmouseover.call(i.api, o),
                                      (i.mouseover = o))))
                            : e());
                })
                .on("click", function () {
                    ...
                    i.hasArcType(o) ||
                        ...
                        (e = i.findClosestFromTargets(o, t)) &&
                            (i.isBarType(e.id) ||
                                i.dist(e, t) < a.point_sensitivity) &&
                            i.main
                                .selectAll(
                                    "." +
                                        r.shapes +
                                ...
                                .each(function () {
                                    (a.data_selection_grouped ||
                                        i.isWithinShape(this, e)) &&
                                        (i.toggleShape(this, e, e.index),
                                        i.config.data_onclick.call(
                                            i.api,
                                            e,
                                            this
                                        ));
            ...
            (t = i.mapToTargetIds(t)),
                i.legend
                    ...
                    .style("opacity", function () {
                        return (
                            e ? i.opacityForLegend : i.opacityForUnfocusedLegend
        ...
        (C.updateLegend = function (t, e, i) {
            ...
            (t = t.filter(function (t) {
                return (
                    !(void 0 !== T.data_names[t]) || null !== T.data_names[t]
                );
            })),
        ...
        (C.getScale = function (t, e, i) {
            return (i ? this.d3.time.scale() : this.d3.scale.linear()).range([
                t,
                e,
            ]);
        }),
            ...
            o.data_selection_enabled &&
                ...
                (o.data_selection_multiple ||
                    n.main
                        ...
                        .each(function (t, e) {
                            var i = a.select(this);
                            i.classed(r.SELECTED) &&
                                d(!1, i.classed(r.SELECTED, !1), t, e);
                        }),
        ...
        (C.getBars = function (t, e) {
            ...
            return (
                e
                    ? i.main.selectAll(
                          "." + r.bars + i.getTargetSelectorSuffix(e)
                      )
                    : i.main
                ...
                t.forEach(function (t) {
                    i.main
                        .selectAll(
                            "." +
                                r.selectedCircles +
                                i.getTargetSelectorSuffix(t.id)
                        )
                    ...
                    for (
                        c = _.getScale(
                            ...
                            g =
                                ...
                                (h =
                                    2 /
                                    Math.sqrt(Math.pow(l, 2) + Math.pow(u, 2))),
                            o = h;
                        o <= 1;
                        o += g
                    )
        ...
        (C.getCircles = function (t, e) {
            ...
            return (
                e
                    ? i.main.selectAll(
                          "." + r.circles + i.getTargetSelectorSuffix(e)
                      )
                    : i.main
        ...
        (C.initSubchart = function () {
            ...
            i.style("visibility", n),
                ...
                (t.axes.subx = i
                    ...
                    .style(
                        "visibility",
                        e.subchart_axis_x_show ? n : "hidden"
                    ));
        }),
