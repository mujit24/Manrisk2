...
(function (t, n) {
                ...
                : function (t) {
                      return function () {
                          var n = this.ownerDocument,
                              e = this.namespaceURI;
                          return e === ps &&
                              n.documentElement.namespaceURI === ps
                              ? n.createElement(t)
    ...
    function Bt(t) {
        ...
        return (
            i === o && o === a
                ? (e = r = u)
                : ((e = jt(
                      (0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / Os
                  )),
                  (r = jt(
                      (0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Bs
                  ))),
                    ...
                    if ((h = u[c]).name === e.name) {
                        ...
                        h.state === ql
                            ? ((h.state = Yl),
                              ...
                              delete u[c])
                            : +c < n &&
                              ((h.state = Yl), h.timer.stop(), delete u[c]);
                    }
                if (
                    (Cn(function () {
                        e.state === Ul &&
    ...
    function Bc(t, n) {
        var e,
            ...
            o = t.sort(Yc).pop();
        for (
            rb = [], nb = new Array(t.length), tb = new _c(), eb = new _c();
            ;
    ...
    var _p,
        ...
        Fp = {
            ...
            polygonEnd: function () {
                (Fp.lineStart = Fp.lineEnd = Fp.point = vr),
                    Yp.add(Jd(Bp)),
                    Bp.reset();
            },
            result: function () {
            ...
            point: function (t, n) {
                ...
                if (((t = +t), (n = +n), t !== this._x1 || n !== this._y1)) {
                    switch (this._point) {
                        ...
                        case 2:
                            (this._point = 3),
                                rc(this, ec(this, (e = nc(this, t, n))), e);
                            break;
                        default:
    ...
    (jc.prototype = Ic.prototype),
        ...
        (t.geoCentroid = function (t) {
            (Sd = Ed = kd = Cd = Pd = zd = Rd = Ld = Dd = Ud = qd = 0),
                br(t, yp);
            var n = Dd,
                e = Ud,
                r = qd,
        ...
        (t.pie = function () {
            function t(t) {
                var u,
                    ...
                    y = Math.min(
                        N_,
                        Math.max(-N_, o.apply(this, arguments) - g)
                    ),
