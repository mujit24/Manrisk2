...
!(function (t, e) {
    ...
    ((e = w.prototype).axisX = function (t, e, i) {
        ...
        (e.generateTicks = function (t) {
            ...
            return (
                n.length > 0 && n[0] > 0 && n.unshift(n[0] - (n[1] - n[0])), n
            );
        }),
                ...
                e.axis_x_tick_format &&
                    (o(e.axis_x_tick_format)
                        ...
                        : t.isTimeSeries() &&
                          (i = function (i) {
                              return i
                                  ? t.axisTimeFormat(e.axis_x_tick_format)(i)
                                  : "";
                          })),
                o(i)
                    ? function (e) {
    ...
    return (
        ...
        (T.initWithData = function (t) {
            ...
            (a.axis = new v(a)),
                ...
                a.config.svg_classname &&
                    a.svg.attr("class", a.config.svg_classname),
                (e = a.svg.append("defs")),
                ...
                (n = a.main =
                    a.svg
                        .append("g")
                        .attr("transform", a.getTranslate("main"))),
                a.initPie && a.initPie(),
                ...
                a.initEventRect(),
                s.axis_x_selection &&
                    a.brush.selectionAsValue(a.getDefaultSelection()),
                o &&
                    (a.updateDimension(),
            ...
            if (
                ...
                Y.length
                    ? (k.updateXDomain(Y, d, u, l),
                      X.axis_x_tick_values ||
                          (V = k.axis.updateXAxisTickValues(Y)))
        ...
        (T.transformMain = function (t, e) {
            ...
            e && e.axisX
                ? (n = e.axisX)
                : ((n = s.main.select("." + i.axisX)),
                  t && (n = n.transition())),
                e && e.axisY
                    ? (a = e.axisY)
                    : ((a = s.main.select("." + i.axisY)),
                      t && (a = a.transition())),
                e && e.axisY2
                    ? (r = e.axisY2)
                    : ((r = s.main.select("." + i.axisY2)),
                      t && (r = r.transition())),
                        ...
                        if (t.id === e[i].id) {
                            for (
                                ...
                                (e[i].values[n].index = f + n),
                                    d.isTimeSeries() ||
                                        (e[i].values[n].x = f + n);
                            (t.values = t.values.concat(e[i].values)),
                                e.splice(i, 1);
                            break;
                        }
                    a || u.push(t.id);
        ...
        (b.focus = function (t) {
            ...
            (t = n.mapToTargetIds(t)),
                (e = n.svg.selectAll(
                    n.selectorTargets(t.filter(n.isTargetToShow, n))
                )),
                this.revert(),
                this.defocus(),
        ...
        (b.load = function (t) {
            ...
            t.xs && e.addXs(t.xs),
                ...
                "cacheIds" in t && e.hasCaches(t.cacheIds)
                    ...
                    ? e.unload(
                          e.mapToTargetIds(
                              "boolean" == typeof t.unload && t.unload
                                  ? null
                                  : t.unload
                          ),
                          function () {
                        ...
                        d.classed(i.line) ||
                            ...
                            (g && f
                                ...
                                : l(n) &&
                                  n &&
                                  p &&
                                  h(!1, d.classed(i.SELECTED, !1), o, c));
                    });
        }),
        ...
        (b.zoom.range = function (t) {
            ...
            l(t.max) && this.domain.max(t.max),
                l(t.min) && this.domain.min(t.min);
        }),
        (T.initPie = function () {
            var t = this,
                e = t.d3;
        ...
        (T.transformForArcLabel = function (t) {
            ...
            if (d && !l)
                ...
                d &&
                l &&
                s.filterTargetsToShow(s.data.targets).length > 1
            ) {
            ...
            n.transiting
                ? (e = window.setInterval(function () {
                      n.transiting ||
                          ...
                          n.legend.selectAll(".c3-legend-item-focused").size() >
                              0 && n.expandArc(t));
                  }, 10))
                : ((t = n.mapToTargetIds(t)),
                  n.svg
            ...
            if (
                ((r = (a = h
                    ...
                    .style("cursor", function (t) {
                        return l.interaction_enabled &&
                            l.data_selection_isselectable(t)
                            ? "pointer"
                            : null;
                    })
                    .each(function (t) {
                        ...
                        : c
                              ...
                              .each(function (t) {
                                  var e = 0,
                                      ...
                                      a = "";
                                  if (
                                      d.hiddenTargetIds.indexOf(t.data.id) < 0
                                  ) {
                                      var r = d.updateAngle(t),
                                          s =
                                              (d.gaugeArcWidth /
                                                  d.filterTargetsToShow(
                                                      d.data.targets
                                                  ).length) *
                                              (r.index + 1),
                        ...
                        l.interaction_enabled
                            ? function (t) {
                                  var e,
                                      i = d.updateAngle(t);
                                  i &&
                                      ((e = [d.convertToArcData(i)]),
                                      d.showTooltip(e, this));
                              }
                            : null
                    )
                    .on(
                        ...
                        l.interaction_enabled
                            ? function (t, e) {
                                  ...
                                  n &&
                                      ...
                                      d.toggleShape &&
                                          d.toggleShape(this, i, e),
                                      d.config.data_onclick.call(
                                          d.api,
                                          i,
                                          this
                                      ));
                ...
                h
                    ...
                    .style("opacity", function (t) {
                        return d.isTargetToShow(t.data.id) &&
                            d.isArcType(t.data)
                            ? 1
                            : 0;
                    }),
                ...
                (s = d.arcs
                    ...
                    s
                        ...
                        .attr("d", function (t) {
                            if (d.hiddenTargetIds.indexOf(t.id) >= 0)
                                return "M 0 0";
                            var e = {
                    ...
                    d.arcs
                        ...
                        .attr(
                            ...
                            -1 *
                                (d.innerRadius +
                                    (d.radius - d.innerRadius) /
                                        (l.gauge_fullCircle ? 1 : 2)) +
                                "px"
                        )
                        .attr("dy", "1.2em")
                        .text(
                            l.gauge_label_show
                                ? d.textForGaugeMinMax(l.gauge_min, !1)
                                : ""
                        ),
                    d.arcs
                        ...
                        .text(
                            l.gauge_label_show
                                ? d.textForGaugeMinMax(l.gauge_max, !0)
                                : ""
                        );
            }
        }),
        ...
        (T.classArc = function (t) {
            return (
                this.classShape(t.data) + this.generateClass(i.arc, t.data.id)
            );
        }),
        (T.classArcs = function (t) {
            return (
                this.classShapes(t.data) + this.generateClass(i.arcs, t.data.id)
            );
        }),
        ...
        (T.classTarget = function (t) {
            ...
            return (
                e && (n = " " + i.target + "-" + e),
                this.generateClass(i.target, t) + n
            );
        }),
        ...
        (T.classFocused = function (t) {
            return (
                " " +
                (this.focusedTargetIds.indexOf(t.id) >= 0 ? i.focused : "")
            );
        }),
                ...
                n.forEach(function (i) {
                    ...
                    o.isCustomX() || o.isTimeSeries()
                        ? a.indexOf(n) >= 0
                            ...
                            : _(d.data_xs) &&
                              (o.data.xs[i] = o.getXValuesOfXKey(
                                  n,
                                  o.data.targets
                              ))
        ...
        (T.load = function (t, e) {
            ...
            t &&
                ...
                (e.type || e.types) &&
                    t.forEach(function (t) {
                        var n =
                            e.types && e.types[t.id] ? e.types[t.id] : e.type;
        ...
        (T.loadFromArgs = function (t) {
            ...
            t.data
                ...
                : t.json
                ? e.load(
                      e.convertDataToTargets(
                          e.convertJsonToData(t.json, t.keys)
                      ),
                      t
                  )
                : t.rows
            ...
            return (
                ...
                0 === m.length
                    ...
                    : (isNaN(v) && (v = 0),
                      ...
                      void 0 !== T &&
                          ((b = T + (c = Math.max(Math.abs(v), Math.abs(b)))),
                          (v = T - c)),
                      C
        ...
        (T.getXDomainPadding = function (t) {
            ...
            return (
                ...
                "object" === n(o.axis_x_padding) && _(o.axis_x_padding)
                    ? ((a = s(o.axis_x_padding.left)
                          ? o.axis_x_padding.left
                          : i),
                      (r = s(o.axis_x_padding.right)
                          ? o.axis_x_padding.right
                          : i))
                    : (a = r =
                          "number" == typeof o.axis_x_padding
                              ? o.axis_x_padding
                              : i),
                { left: a, right: r }
            );
            ...
            (t = n.mapToTargetIds(t)),
                n.legend
                    ...
                    .style("opacity", function () {
                        return (
                            e ? n.opacityForLegend : n.opacityForUnfocusedLegend
        ...
        (T.updateScales = function () {
            ...
            (t.xMin = e.axis_rotated ? 1 : 0),
                ...
                (t.y = t.getY(
                    t.yMin,
                    t.yMax,
                    i ? e.axis_y_default : t.y.domain()
                )),
                (t.y2 = t.getY(
                    t.yMin,
                    t.yMax,
                    i ? e.axis_y2_default : t.y2.domain()
                )),
            ...
            s.data_selection_enabled &&
                ...
                (s.data_selection_multiple ||
                    a.main
                        ...
                        .each(function (t, e) {
                            var n = r.select(this);
                            n.classed(i.SELECTED) &&
                                d(!1, n.classed(i.SELECTED, !1), t, e);
                        }),
        ...
        (T.getBars = function (t, e) {
            return (
                e
                    ? this.main.selectAll(
                          "." + i.bars + this.getTargetSelectorSuffix(e)
                      )
                    : this.main
        ...
        (T.expandBars = function (t, e, n) {
            n && this.unexpandBars(),
                this.getBars(t, e).classed(i.EXPANDED, !0);
        }),
        ...
        (T.generateDrawLine = function (t, e) {
            ...
            return (
                ...
                function (t) {
                    var r,
                        o = n.line_connectNull
                            ? i.filterRemoveNull(t.values)
                            : t.values,
                        c = e ? i.subX : i.x,
                        d = s.call(i, t.id),
                        u = 0,
            ...
            return (
                ...
                function (t) {
                    ...
                    return (
                        i.isAreaType(t)
                            ? (i.isStepType(t) &&
                                  (r = i.convertValuesToStep(r)),
                              (e = a.curve(i.getInterpolate(t))(r)))
                            : (r[0] &&
                                  ((s = i.x(r[0].x)),
                                  (o = i.getYScale(t.id)(r[0].value))),
                              (e = n.axis_rotated
                                  ? "M " + o + " " + s
                                  : "M " + s + " " + o)),
                        e || "M 0 0"
        ...
        (T.initBrush = function (t) {
            ...
            return (
                ...
                (e.brush.selection = function () {
                    return n.brushSelection(
                        e.context.select("." + i.brush).node()
                    );
                }),
        ...
        (T.isLineType = function (t) {
            ...
            return (
                ...
                [
                    ...
                    "step",
                    "area-step",
                ].indexOf(e.data_types[i]) >= 0
            );
        }),
        (T.isStepType = function (t) {
            var e = d(t) ? t : t.id;
            return (
                ["step", "area-step"].indexOf(this.config.data_types[e]) >= 0
            );
        }),
                ...
                (e.zoom.updateDomain = function () {
                    return (
                        i.event &&
                            i.event.transform &&
                            e.x.domain(
                                i.event.transform.rescaleX(e.subX).domain()
                            ),
                        this
                    );
                }),
