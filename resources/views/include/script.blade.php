...
<script src="{{ asset('js/pages/file/filemanager.js') }}"></script>

<script src="{{ asset('js/hospital/index-patient.js') }}"></script>
...
<script src="{{ asset('assets/vendor/jquery-steps/jquery.steps.min.js') }}"></script> <!-- JQuery Steps Plugin Js -->
<script src="{{ asset('js/pages/forms/form-wizard.js') }}"></script>

<!-- Dashboard Chart -->
<script src="{{ asset('js/pages/charts/apex.js') }}"></script>
<script src="{{ asset('js/pages/charts/c3.js') }}"></script>
