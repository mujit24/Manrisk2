...
// Risk Register Divisi oleh MR
Route::get('/input-risk-divisi/{id}', [ResikoDivisiController::class, 'index'])->name('input-risk-divisi');
// 1. Identifikasi
// 1.1 Sasaran
Route::post('/input-sasaran-add', [ResikoDivisiController::class, 'store_sasaran'])->name('input-sasaran-add');
Route::get('/input-sasaran-edit', [ResikoDivisiController::class, 'edit_sasaran'])->name('input-sasaran-edit');
Route::match(['put', 'patch'], '/input-sasaran-update/{id}', [ResikoDivisiController::class, 'update_sasaran'])->name('input-sasaran-update');
Route::get('/input-sasaran-delete/{id}', [ResikoDivisiController::class, 'destroy_sasaran'])->name('input-sasaran-delete');

// 1.2 Tujuan
Route::post('/input-tujuan-add', [ResikoDivisiController::class, 'store_tujuan'])->name('input-tujuan-add');
Route::get('/input-tujuan-edit', [ResikoDivisiController::class, 'edit_tujuan'])->name('input-tujuan-edit');
Route::match(['put', 'patch'], '/input-tujuan-update/{id}', [ResikoDivisiController::class, 'update_tujuan'])->name('input-tujuan-update');
Route::get('/input-tujuan-delete/{id}', [ResikoDivisiController::class, 'destroy_tujuan'])->name('input-tujuan-delete');
Route::get('/get-sasaran', [ResikoDivisiController::class, 'getSasaranByTahun']);

// 1.3 Event
Route::post('/input-event-add', [ResikoDivisiController::class, 'store_event'])->name('input-event-add');
Route::get('/input-event-edit', [ResikoDivisiController::class, 'edit_event'])->name('input-event-edit');
Route::match(['put', 'patch'], '/input-event-update/{id}', [ResikoDivisiController::class, 'update_event'])->name('input-event-update');
Route::get('/input-event-delete/{id}', [ResikoDivisiController::class, 'destroy_event'])->name('input-event-delete');
Route::get('/get-tujuan', [ResikoDivisiController::class, 'getTujuanByTahun']);

// 1.4 Resiko
Route::post('/input-resiko-add', [ResikoDivisiController::class, 'store_resiko'])->name('input-resiko-add');
Route::get('/input-resiko-edit', [ResikoDivisiController::class, 'edit_resiko'])->name('input-resiko-edit');
Route::match(['put', 'patch'], '/input-resiko-update/{id}', [ResikoDivisiController::class, 'update_resiko'])->name('input-resiko-update');
Route::get('/input-resiko-delete/{id}', [ResikoDivisiController::class, 'destroy_resiko'])->name('input-resiko-delete');
Route::get('/get-event', [ResikoDivisiController::class, 'getEventByTahun'])->name('event.byYear');


// 2. Pengukuran
Route::post('/input-pengukuran-add', [ResikoDivisiController::class, 'store_pengukuran'])->name('input-pengukuran-add');
Route::get('/input-pengukuran-edit', [ResikoDivisiController::class, 'edit_pengukuran'])->name('input-pengukuran-edit');
Route::match(['put', 'patch'], '/input-pengukuran-update/{id}', [ResikoDivisiController::class, 'update_pengukuran'])->name('input-pengukuran-update');
Route::get('/input-pengukuran-delete/{id}', [ResikoDivisiController::class, 'destroy_pengukuran'])->name('input-pengukuran-delete');


// 3. Pengendalian
Route::post('/input-pengendalian-add', [ResikoDivisiController::class, 'store_pengendalian'])->name('input-pengendalian-add');
Route::get('/input-pengendalian-edit', [ResikoDivisiController::class, 'edit_pengendalian'])->name('input-pengendalian-edit');
Route::match(['put', 'patch'], '/input-pengendalian-update/{id}', [ResikoDivisiController::class, 'update_pengendalian'])->name('input-pengendalian-update');
Route::get('/input-pengendalian-delete/{id}', [ResikoDivisiController::class, 'destroy_pengendalian'])->name('input-pengendalian-delete');


// 4. Monitoring Divisi
Route::post('/input-monitoring-add', [ResikoDivisiController::class, 'store_monitoring'])->name('input-monitoring-add');
Route::get('/input-monitoring-edit', [ResikoDivisiController::class, 'edit_monitoring'])->name('input-monitoring-edit');
Route::match(['put', 'patch'], '/input-monitoring-update/{id}', [ResikoDivisiController::class, 'update_monitoring'])->name('input-monitoring-update');
Route::get('/input-monitoring-delete/{id}', [ResikoDivisiController::class, 'destroy_monitoring'])->name('input-monitoring-delete');
